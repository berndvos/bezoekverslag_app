      ...
      <form method="post" action="<?= $formAction ?>" enctype="multipart/form-data" id="ruimte-form">
        ...
        <div id="ruimte" class="section-anchor card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label">Ruimte</label>
                <input type="text" name="naam" class="form-control" value="<?= htmlspecialchars($ruimte['naam'] ?? '') ?>" required>
              </div>
              <div class="col-md-6">
                <label class="form-label">Etage</label>
                <input type="text" name="etage" class="form-control" value="<?= htmlspecialchars($ruimte['etage'] ?? '') ?>">
              </div>

              <?php if ($schema_version == 2): ?>
                <div class="col-md-4">
                    <label class="form-label">Lengte ruimte (m)</label>
                    <input type="text" name="lengte_ruimte" class="form-control" value="<?= htmlspecialchars($ruimte['lengte_ruimte']) ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Breedte ruimte (m)</label>
                    <input type="text" name="breedte_ruimte" class="form-control" value="<?= htmlspecialchars($ruimte['breedte_ruimte']) ?>">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Hoogte plafond (m)</label>
                    <input type="text" name="hoogte_plafond" class="form-control" value="<?= htmlspecialchars($ruimte['hoogte_plafond']) ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Type plafond</label>
                    <input type="text" name="type_plafond" class="form-control" value="<?= htmlspecialchars($ruimte['type_plafond']) ?>">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Ruimte boven plafond (cm)</label>
                    <input type="text" name="ruimte_boven_plafond" class="form-control" value="<?= htmlspecialchars($ruimte['ruimte_boven_plafond']) ?>">
                </div>
              <?php endif; ?>

              <div class="col-12">
                <label class="form-label">Opmerkingen</label>
                <textarea name="opmerkingen" class="form-control" rows="3"><?= htmlspecialchars($ruimte['opmerkingen'] ?? '') ?></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="huidige" class="section-anchor card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-4">
                <label class="form-label">Aantal aansluitingen</label>
                <input type="number" name="aantal_aansluitingen" class="form-control"
                       value="<?= htmlspecialchars($ruimte['aantal_aansluitingen'] ?? '') ?>">
              </div>
              <div class="col-md-8">
                <label class="form-label">Type aansluitingen</label>
                <input type="text" name="type_aansluitingen" class="form-control"
                       placeholder="Bijv. HDMI, DisplayPort, USB-C..."
                       value="<?= htmlspecialchars($ruimte['type_aansluitingen'] ?? '') ?>">
              </div>
              <div class="col-md-6">
                <label class="form-label">Huidig schermtype / grootte</label>
                <input type="text" name="huidig_scherm" class="form-control"
                       value="<?= htmlspecialchars($ruimte['huidig_scherm'] ?? '') ?>">
              </div>
              <div class="col-md-3">
                <label class="form-label">Audio aanwezig</label>
                <select name="audio_aanwezig" class="form-select">
              ...
              <div class="col-md-12">
                <label class="form-label">Beeldkwaliteit opmerkingen</label>
                <textarea name="beeldkwaliteit" class="form-control" rows="2"><?= htmlspecialchars($ruimte['beeldkwaliteit'] ?? '') ?></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="huidige" class="section-anchor card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
                <div class="col-12">
                    <label class="form-label">Beschrijving huidige situatie</label>
                    <textarea name="huidige_situatie_v2" class="form-control" rows="5"><?= htmlspecialchars($ruimte['huidige_situatie_v2']) ?></textarea>
                </div>
            </div>
          </div>
        </div>
        ...
        <div id="wensen" class="section-anchor card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label">Gewenste schermgrootte</label>
                <input type="text" name="gewenst_scherm" class="form-control" value="<?= htmlspecialchars($ruimte['gewenst_scherm'] ?? '') ?>">
              </div>
              <div class="col-md-6">
                <label class="form-label">Gewenste aansluitingen</label>
                <input type="text" name="gewenst_aansluitingen" class="form-control"
                       placeholder="Bijv. HDMI, USB-C..." value="<?= htmlspecialchars($ruimte['gewenst_aansluitingen'] ?? '') ?>">
              </div>
              <div class="col-md-6">
                <label class="form-label">Presentatiemethode</label>
                <select name="presentatie_methode" class="form-select">
                  <option value="">Kies...</option>
              ...
              <div class="col-md-3">
                <label class="form-label">Geluid gewenst</label>
                <select name="geluid_gewenst" class="form-select">
                  <option value="">Kies...</option>
              ...
              <div class="col-md-12">
                ...
                <textarea name="overige_wensen" class="form-control" rows="3"><?= htmlspecialchars($ruimte['overige_wensen'] ?? '') ?></textarea>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="bekabeling" class="section-anchor card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-3">
                <label class="form-label">Kabeltraject mogelijk</label>
                <select name="kabeltraject_mogelijk" class="form-select">
                  <option value="">Kies...</option>
              ...
              <div class="col-md-9">
                <label class="form-label">Beperkingen / obstakels</label>
                <input type="text" name="beperkingen" class="form-control" value="<?= htmlspecialchars($ruimte['beperkingen'] ?? '') ?>">
              </div>
              <div class="col-md-6">
                <label class="form-label">Ophanging scherm</label>
                <select name="ophanging" class="form-select">
                  <option value="">Kies...</option>
              ...
              <?php if ($schema_version == 2): ?>
                <div class="col-md-6">
                    <label class="form-label">Type wand</label>
                    <input type="text" name="type_wand" class="form-control" value="<?= htmlspecialchars($ruimte['type_wand']) ?>">
                </div>
              <?php endif; ?>
              <div class="col-md-12">
                <label class="form-label">Extra montagewensen</label>
                <input type="text" name="montage_extra" class="form-control" value="<?= htmlspecialchars($ruimte['montage_extra'] ?? '') ?>">
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="stroom" class="section-anchor card shadow-sm mb-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-4">
                <label class="form-label">Voldoende stroompunten aanwezig?</label>
                <select name="stroom_voldoende" class="form-select">
                  <option value="">Kies...</option>
              ...
              <div class="col-md-8">
                <label class="form-label">Extra nodig</label>
                <input type="text" name="stroom_extra" class="form-control" value="<?= htmlspecialchars($ruimte['stroom_extra'] ?? '') ?>">
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="voorzieningen" class="section-anchor card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                        <label class="form-label">Aanwezig?</label>
                        <select name="stroom_aanwezig" class="form-select">
                            <option value="">Kies...</option>
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Extra nodig</label>
                        <input type="text" name="stroom_extra_v2" class="form-control" value="<?= htmlspecialchars($ruimte['stroom_extra_v2']) ?>">
                    </div>
                    <div class="col-md-5">
                        <label class="form-label">Geschatte afstand (m)</label>
                        <input type="text" name="stroom_afstand" class="form-control" value="<?= htmlspecialchars($ruimte['stroom_afstand']) ?>">
                    </div>
                </div>
                <hr>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <label class="form-label">Aanwezig?</label>
                        <select name="netwerk_aanwezig" class="form-select">
                            <option value="">Kies...</option>
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Extra nodig</label>
                        <input type="text" name="netwerk_extra" class="form-control" value="<?= htmlspecialchars($ruimte['netwerk_extra']) ?>">
                    </div>
                    <div class="col-md-5">
                        <label class="form-label">Geschatte afstand (m)</label>
                        <input type="text" name="netwerk_afstand" class="form-control" value="<?= htmlspecialchars($ruimte['netwerk_afstand']) ?>">
                    </div>
                </div>
            </div>
        </div>
